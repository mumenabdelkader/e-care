...
import 'customes/custom_signup_google.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                    Text("Forgot Password?",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold,color: Color.fromRGBO(37, 124, 255, 1)),)
                ],
              ),
              SizedBox(height: 42,),
              ...
              Row(
                ...
                children: [
                  Text(" Don’t have account? ",style:  TextStyle(color: Color.fromRGBO(128, 141, 158, 1)),),
                  GestureDetector(
                      onTap: (){
                        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) =>SignUp() ,));
                      },
                      child: Text("Sign Up ",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 14,color: Color.fromRGBO(37, 124, 255, 1)))),
                ],
              )
